...
type
  ...
  public
    ...
    [SwagProp('Ocorrencia Urgência', True)]
    property Urgencia: Byte read GetUrgencia write SetUrgencia;

    [SwagProp('Ocorrencia Descrição', True)]
    ...
    [SwagProp('Ocorrencia Data e Hora alteração', True)]
    property DataAlteracao: TDateTime read GetDataAlteracao write SetDataAlteracao;

    [SwagProp('Ocorrencia Usuário', True)]
    property Usuario: TUsuario read GetUsuario write SetUsuario;

    [SwagProp('Ocorrencia Endereço', True)]
